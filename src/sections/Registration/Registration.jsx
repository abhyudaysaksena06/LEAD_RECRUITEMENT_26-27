...
import { COMMUNITY_LINKS } from '../../config/community'
...
export default function Registration() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Trigger edge function asynchronously as direct fallback
    // (Supabase Database Webhook will also trigger in background if configured)
    try {
      ...
      // Ignored: webhook or offline fallback handles it
    }
